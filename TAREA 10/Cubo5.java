...
// Frente
            ...
            (float) 0.5, (float) 0.25,(float) 0.5, // 6 2
            1, (float) 0.25, (float) 0.5, // 7 3
// Atrás
            1, (float) 0.25,1, // 3 4
            (float) 0.5, (float) 0.25,1, // 2 5
            (float) 0.5,-1,1, // 1 6
            1,-1,1, // 0 7
// Izquierda
            1, -1, 1,// 0 8
            1, -1, (float) 0.5,// 4 9
            1, (float) 0.25, (float) 0.5,// 7 10
            1, (float) 0.25, 1, // 3 11
// Derecha
            (float) 0.5,-1, (float) 0.5, // 5 12
            (float) 0.5,-1,1, // 1 13
            (float) 0.5, (float) 0.25,1, // 2 14
            (float) 0.5, (float) 0.25, (float) 0.5, // 6 15
// Abajo
            0, 0, 0, // 7 20
            0, 0, 0, // 6 21
            0, 0,0, // 2 22
...
// Derecha - rojo
            ...
            maxColor, maxColor, 0, maxColor, // 7 3
// Abajo - azul
            maxColor, 0, 0, maxColor, // 4 0
            maxColor, 0, 0, maxColor, // 5 1
            maxColor, 0, 0, maxColor, // 6 2
            maxColor, 0, 0, maxColor, // 7 3
// Arriba - verde
            maxColor, 0, 0, maxColor, // 4 0
            maxColor, 0, 0, maxColor, // 5 1
            maxColor, 0, 0, maxColor, // 6 2
