...
// Frente
            ...
            (float) -1.75, 1,(float) -1.75, // 6 2
            (float) -1.75, 1, (float) -1.75, // 7 3
// Atrás
            (float) -1.75, 1,(float) -1.75, // 3 4
            (float) -1.75, 1,(float) -1.75, // 2 5
            (float) -1.5,-1,-2, // 1 6
            -2,-1, -2, // 0 7
// Izquierda
            -2, -1, -2, // 0 8
            -2, -1, (float) -1.5, // 4 9
            (float) -1.75, 1, (float) -1.75, // 7 10
            (float) -1.75, 1, (float) -1.75, // 3 11

// Derecha
            (float) -1.5,-1, (float) -1.5, // 5 12
            (float) -1.5,-1,-2, // 1 13
            (float) -1.75, 1,(float) -1.75, // 2 14
            (float) -1.75, 1, (float) -1.75, // 6 15
// Abajo
            0, 0, 0, // 0 16
            0, 0, 0, // 1 17
            0, 0, 0, // 5 18
